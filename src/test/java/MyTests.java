...
public class MyTests {
  ...
  public void testCountX() {
    assertEquals(
        1,
        MyMain.countX("hix"),
        "The number of times 'x' shows up in " + "hix" + " should be: " + 1);
    assertEquals(
        2,
        MyMain.countX("xoxo"),
        "The number of times 'x' shows up in " + "xoxo" + " should be: " + 2);
    assertEquals(
        2,
        MyMain.countX("xhix"),
        "The number of times 'x' shows up in " + "xhix" + " should be: " + 2);
    assertEquals(
        3,
        MyMain.countX("xhixhix"),
        "The number of times 'x' shows up in " + "xhixhix" + " should be: " + 3);
  }
  ...
  public void testCountHi() {
    assertEquals(
        1,
        MyMain.countHi("hix"),
        "The number of times \"hi\" shows up in " + "hix" + " should be: " + 1);
    assertEquals(
        2,
        MyMain.countHi("hellohihi"),
        "The number of times \"hi\" shows up in " + "hellohihi" + " should be: " + 2);
    assertEquals(
        2,
        MyMain.countHi("hellohibyehi"),
        "The number of times \"hi\" shows up in " + "hellohihi" + " should be: " + 2);
    assertEquals(
        1,
        MyMain.countHi("hihello"),
        "The number of times \"hi\" shows up in " + "hihello" + " should be: " + 1);
    assertEquals(
        0,
        MyMain.countHi("x"),
        "The number of times \"hi\" shows up in " + "x" + " should be: " + 0);
    assertEquals(
        1,
        MyMain.countHi("hi"),
        "The number of times \"hi\" shows up in " + "hi" + " should be: " + 1);
  }
}
